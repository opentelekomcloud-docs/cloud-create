...
The service catalogs are modelled using TOSCA (i.e., a YAML file definition of the service). They are open-source and available on `our Github <https://github.com/opentelekomcloud-blueprints/tosca-service-catalogs>`_.
